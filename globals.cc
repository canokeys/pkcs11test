...
CK_ULONG g_so_pin_len = 6;
bool g_destructive_piv = false;
bool g_expected_serial_set = false;
CK_ULONG g_expected_serial = 0;
...
std::map<std::string, SignatureInfo> kSignatureInfo = {
    // CKM_RSA_PKCS has restrictions on data sizes (see PKCS#11 s12.1.6 table
    // 37).
    {"RSA", {CKM_RSA_PKCS, 64}},
...
std::map<std::string, CipherInfo> kCipherInfo = {
    ...
    // PKCS#11 v2.20 amendment 3
    {"CAMELLIA-ECB",
     {CKK_CAMELLIA, CKM_CAMELLIA_KEY_GEN, CKM_CAMELLIA_ECB, 16, false, -1}},
    {"CAMELLIA-CBC",
     {CKK_CAMELLIA, CKM_CAMELLIA_KEY_GEN, CKM_CAMELLIA_CBC, 16, true, -1}},
    {"CAMELLIA-CBC-PAD",
     {CKK_CAMELLIA, CKM_CAMELLIA_KEY_GEN, CKM_CAMELLIA_CBC_PAD, 16, true, -1}},
    {"ARIA-ECB", {CKK_ARIA, CKM_ARIA_KEY_GEN, CKM_ARIA_ECB, 16, false, -1}},
    {"ARIA-CBC", {CKK_ARIA, CKM_ARIA_KEY_GEN, CKM_ARIA_CBC, 16, true, -1}},
    {"ARIA-CBC-PAD",
     {CKK_ARIA, CKM_ARIA_KEY_GEN, CKM_ARIA_CBC_PAD, 16, true, -1}},
};
